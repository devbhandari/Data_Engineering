...
The 'pyspark_with_Databricks' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/pyspark_with_Databricks/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] pyspark_with_Databricks_etl` to your workspace.
